...
@section('content')
    ...
    <form method="POST" action="{{url("profesores/{$profesor->id}")}}" enctype="multipart/form-data">
        ...
        <div class="form-group col-6">
            ...
            <div class="col-md-6">
                <input type="radio" name="estado" value="ACTIVO" id="estado">
                Activo<br/>

                <input type="radio" name="estado" value="SABATICO" id="estado">
                Sabatico<br/>

                <input type="radio" name="estado" value="JUBILADO" id="estado">
                Jubilado<br/>
            </div>
    ...
    <p>
        <a href="{{route('profesores')}}">Regresar al listado de Profesores</a>
    </p>
